...
func (m *Asset) GetOracleScriptId() uint64 {
	if m != nil {
...
func init() {
	proto.RegisterType((*Asset)(nil), "songwongtp.asset.asset.Asset")
}
...
var fileDescriptor_06b463ba992d3361 = []byte{
	...
	0x2d, 0xd1, 0x07, 0x93, 0x7a, 0x05, 0x45, 0xf9, 0x25, 0xf9, 0x42, 0x62, 0xc5, 0xf9, 0x79, 0xe9,
	0xe5, 0xf9, 0x79, 0xe9, 0x25, 0x05, 0x7a, 0x10, 0x71, 0x30, 0xa9, 0x94, 0xc5, 0xc5, 0xea, 0x08,
	0x62, 0x08, 0x89, 0x70, 0xb1, 0xa6, 0xa4, 0xe6, 0xe5, 0xe7, 0x4a, 0x30, 0x2a, 0x30, 0x6a, 0x70,
	0x06, 0x41, 0x38, 0x42, 0x8a, 0x5c, 0x3c, 0x25, 0xf9, 0x25, 0x89, 0x39, 0xf1, 0xc5, 0xa5, 0x05,
	0x05, 0x39, 0x95, 0x12, 0x4c, 0x0a, 0x8c, 0x1a, 0x2c, 0x41, 0xdc, 0x60, 0xb1, 0x60, 0xb0, 0x90,
	0x90, 0x06, 0x97, 0x40, 0x7e, 0x51, 0x62, 0x72, 0x4e, 0x6a, 0x7c, 0x71, 0x72, 0x51, 0x66, 0x41,
	0x49, 0x7c, 0x66, 0x8a, 0x04, 0x33, 0x58, 0x19, 0x1f, 0x44, 0x3c, 0x18, 0x2c, 0xec, 0x99, 0xe2,
	...
	0x19, 0xa5, 0x49, 0x7a, 0xc9, 0xf9, 0xb9, 0xfa, 0x08, 0x87, 0x42, 0x3c, 0xa0, 0x9b, 0x9c, 0x91,
	0x98, 0x99, 0xa7, 0x5f, 0x01, 0xe1, 0xe9, 0x97, 0x54, 0x16, 0xa4, 0x16, 0x27, 0xb1, 0x81, 0x7d,
	0x65, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0xf3, 0xee, 0xce, 0x31, 0xea, 0x00, 0x00, 0x00,
}
...
func (m *Asset) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.OracleScriptId != 0 {
		i = encodeVarintAsset(dAtA, i, uint64(m.OracleScriptId))
		i--
		dAtA[i] = 0x18
	}
	if m.TotalSupply != 0 {
		i = encodeVarintAsset(dAtA, i, uint64(m.TotalSupply))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Denom) > 0 {
...
func (m *Asset) Size() (n int) {
	...
	if m.TotalSupply != 0 {
		n += 1 + sovAsset(uint64(m.TotalSupply))
	}
	if m.OracleScriptId != 0 {
		n += 1 + sovAsset(uint64(m.OracleScriptId))
	}
	return n
}
